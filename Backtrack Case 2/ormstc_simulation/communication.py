...
class CommunicationSystem:
    ...
    def is_robot_alive(self, robot_id):
        ...
        is_alive = (current_time - last_activity) < timeout_threshold \
           or self.robot_states[robot_id].get("completed", False)
    ...
    def broadcast_unclaim(self, sender_id: int, cells: list[tuple[int,int]]):
        self.broadcast_message(
            sender_id,
            "unclaim",  # or MessageType.UNCLAIM if you added it
            {"cells": cells}
        )
